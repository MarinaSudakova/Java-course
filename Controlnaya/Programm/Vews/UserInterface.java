package Controlnaya.Programm.Vews;
...
import Controlnaya.Programm.Model.PackAnimal;
import Controlnaya.Programm.Model.Pet;
...
public class UserInterface {
    ...
    public void showEntry(List<String[]> data, String title, List<String[]> commands) {
        ...
        for (String[] entry : data) {
            if (entry.length > 1) {
                System.out
                        .print(i + ") Кличка: " + entry[0] + ", Порода: " + entry[1] + ", Дата рождения: " + entry[2]);
