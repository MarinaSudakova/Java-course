...
public class Task_1 {
    public static void main(String[] args) {
        int[] array1 = { 8, 1, -3, 5, 6, 9, 8, -4, 2, -99, 43 };
    ...
    public static int[] mergesortInner(int[] buffer1, int[] buffer2,
        ...
        if (startIndex >= endIndex - 1) {
            return buffer1; // остановка в рекурсии
        }

        int middle = startIndex + (endIndex - startIndex) / 2;
        int[] sorted1 = mergesortInner(buffer1, buffer2, startIndex, middle); // левая половинка
        int[] sorted2 = mergesortInner(buffer1, buffer2, middle, endIndex); // правая половинка
